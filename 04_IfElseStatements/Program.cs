...
namespace _04_IfElseStatements
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //testing if (userIsHungry = true), could also test the false as (!userIsHungry) to run code in {}
            if (userIsHungry)
            {
            ...
            {
                Console.WriteLine("Are you even trying to learn?");
            }
            ...
            if (choresAreDone)
            {
                Console.WriteLine("Have fun watching Netflix!");
            }
            else
            {
                Console.WriteLine("You must stay hoe and finish your chores.");
            }
